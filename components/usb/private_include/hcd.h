...
typedef enum hcd_port_state_obj hcd_port_state_t;
...
typedef enum hcd_pipe_state_obj hcd_pipe_state_t;
 ...
 */
typedef bool (*hcd_pipe_isr_callback_t)(hcd_pipe_handle_t ctrl_pipe, hcd_pipe_event_t pipe_event, void *user_arg, bool in_isr);
 ...
 * @param[out] ctrl_pipe Pipe handle
 *
 ...
 */
esp_err_t hcd_pipe_alloc(hcd_port_handle_t port_hdl, const hcd_pipe_config_t *pipe_config, hcd_pipe_handle_t *ctrl_pipe);
 ...
 */
esp_err_t hcd_pipe_update(hcd_pipe_handle_t ctrl_pipe, uint8_t dev_addr, int mps);
 ...
 * @return void* Context variable
 */
void *hcd_pipe_get_ctx(hcd_pipe_handle_t ctrl_pipe);
 ...
 */
hcd_pipe_state_t hcd_pipe_get_state(hcd_pipe_handle_t ctrl_pipe);
 ...
 */
esp_err_t hcd_pipe_command(hcd_pipe_handle_t ctrl_pipe, hcd_pipe_cmd_t command);
 ...
 */
hcd_pipe_event_t hcd_pipe_get_event(hcd_pipe_handle_t ctrl_pipe);
 ...
 */
esp_err_t hcd_irp_enqueue(hcd_pipe_handle_t ctrl_pipe, usb_irp_t *irp);
 ...
 */
usb_irp_t *hcd_irp_dequeue(hcd_pipe_handle_t ctrl_pipe);
